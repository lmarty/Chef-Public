...
default[:emailer][:tempdir] = "c:\\chef\\tmp"

# to is an array so that multiple addresses can be specified
default[:emailer][:to] = ['mail@smashrun.com']

default[:emailer][:from] = "mail@smashrun.com"
default[:emailer][:version] = ['2.3.0']
default[:emailer][:gem] = ['mail']
