Vagrant.configure("2") do |config|
  ...
  config.vm.define :ubuntu1210 do |ubuntu1210|
    ...
    ubuntu1210.vm.hostname = 'gflags-ubuntu-1210'
  end
  ...
  config.vm.define :ubuntu1304 do |ubuntu1304|
    ...
    ubuntu1304.vm.hostname = 'gflags-ubuntu-1304'
  end
